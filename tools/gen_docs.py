...
RULE_NOTES = {
    ...
    "location": "the whole value of a `location` line, including FortiOS "
                "`set location`, and RouterOS's `location=`; never a JunOS "
                "`location {` stanza opener",
    "contact": "the whole value of a `contact` line, FortiOS `set "
               "contact-info`, and RouterOS's `contact=`",
    ...
    "hardware-model": "a `Model:` / `Hardware:` / `Chassis type:` / `PID:` "
                      ...
                      "(<model>, <release>)` header; the model in FortiOS's "
                      "`#config-version=` header; and RouterOS's "
                      "`# model = X`",
    "os-version": "a `version <digits...>` line: IOS `version 15.7`, NX-OS "
                  ...
                  "header; the release, build and `#buildno=` / "
                  "`#branch_pt=` lines of FortiOS's `#config-version=` "
